...
static void logger_file_write_header(FILE *file) {
  ...
  fprintf(file, "raw_of_y, lp_const_of, of_y, of_y_d,");
...
static void logger_file_write_row(FILE *file) {
  ...
  fprintf(file, "%f,%f,%f,%f,", visual_servoing.raw_of_y, visual_servoing.lp_const_of, visual_servoing.of_y, visual_servoing.of_y_d);
